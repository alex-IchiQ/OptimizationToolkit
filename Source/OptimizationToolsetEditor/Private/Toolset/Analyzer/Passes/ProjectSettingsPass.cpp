...
void FProjectSettingsPass::Run(const FLevelScanContext& Context, const FAnalyzeThresholds& T, FScanResult& Out) const
{
	...
	{
		FFinding F(TEXT("Project.OcclusionCullingDisabled"), ESeverity::Critical, ECategory::Project,
	...
	{
		FFinding F(TEXT("Project.StaticLightingWithLumen"), ESeverity::Major, ECategory::Project,
	...
	{
		FFinding F(TEXT("Project.RayTracingEnabled"), ESeverity::Minor, ECategory::Project,
		...
		{
			FFinding G(TEXT("Project.RayTracingWithoutSkinCache"), ESeverity::Major, ECategory::Project,
